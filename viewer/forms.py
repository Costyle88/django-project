...
from django.forms import (
    CharField, DateField, Form, IntegerField, ModelChoiceField, Textarea, DateInput, ModelForm, CheckboxSelectMultiple
)
...
class MovieForm(ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'released': DateInput(attrs={'type': 'date'}),
            'actors': CheckboxSelectMultiple,
                   # Permite selectarea multiplelor actori
            }
...
class ActorSearchForm(forms.Form):
    actor_name = forms.CharField(max_length=100, label='Search for Actor')