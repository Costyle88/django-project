...
from viewer.forms import ActorSearchForm
...
class ActorSearchView(View):
    template_name = 'actor_search_results.html'
    def get(self, request):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            movies = Movie.objects.filter(actors__name__icontains=actor_name)
