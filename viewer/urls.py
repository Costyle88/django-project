...
from viewer.views import MoviesView, MoviesViewDetail, GenreMoviesView, MovieCreateView, MovieDeleteView, MovieUpdateView, ActorSearchView

# Important: Atunci cand avem path-uri definite in alte apps
...
urlpatterns = [
    ...
    path('search-actor/', ActorSearchView.as_view(), name='actor-search'),
]